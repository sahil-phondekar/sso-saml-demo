...
exports.generateSignedSAML2Response = void 0;
var xmlCrypto = _interopRequireWildcard(require("xml-crypto"));
var _xmldom = require("xmldom");
var _generateUnsignedSaml2Response = require("./generate-unsigned-saml2-response");
...
const generateSignedSAML2Response = ({
  data,
  keys
}) => {
  ...
  const doc = new _xmldom.DOMParser().parseFromString(saml2ResponseXML.toString(), "text/xml");
...
exports.generateSignedSAML2Response = generateSignedSAML2Response;