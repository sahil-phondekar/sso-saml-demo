...
exports.generateAssertionSignedSaml2Response = void 0;
...
const generateAssertionSignedSaml2Response = ({
  data,
  keys
}) => {
  const {
  ...
  const saml2XML = xmlbuilder2.create(options, {
    "saml2p:Response": _objectSpread(_objectSpread(_objectSpread({}, saml2ResponseAttributes), saml2IssuerNode), saml2StatusNode)
  });
...
exports.generateAssertionSignedSaml2Response = generateAssertionSignedSaml2Response;